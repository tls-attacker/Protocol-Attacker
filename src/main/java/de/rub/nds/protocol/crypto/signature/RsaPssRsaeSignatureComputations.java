...
public class RsaPssRsaeSignatureComputations extends SignatureComputations {
    ...
    /** M' = 0x0000000000000000 || digest || salt */
    ...
    public RsaPssRsaeSignatureComputations() {}
    ...
    public void setMaskedDb(ModifiableByteArray maskedDb) {
        this.maskedDb = maskedDb;
    }

    public void setMaskedDb(byte[] maskedDb) {
        this.maskedDb = ModifiableVariableFactory.safelySetValue(this.maskedDb, maskedDb);
    }
