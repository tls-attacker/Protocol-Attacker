...
/**
 * Represents the 4096-bit FFDH group defined in RFC 7919 for use in TLS. This group provides a
 * standard 4096-bit prime modulus and generator for Diffie-Hellman operations.
 */
public class Rfc7919Group4096 extends FfdhGroupParameters {

    /**
     * Constructs the RFC 7919 4096-bit FFDH group with predefined parameters. The generator is 2
     * and the modulus is the 4096-bit prime specified in RFC 7919.
     */
    /** Default constructor for deserialization. */
    @SuppressWarnings("unused")
    private Rfc7919Group4096(boolean unused) {
        super(null, null);
    }

    public Rfc7919Group4096() {
        super(
                new BigInteger("2", 16),
                new BigInteger(
